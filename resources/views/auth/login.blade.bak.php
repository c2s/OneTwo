...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $assets_url ?>/css/admin/login.css" />
...
<div class="login ivu-row-flex ivu-row-flex-center" @keydown.enter="handleSubmit">
    <div class="login-con" id="app">
        <div class="logo">
            ...
            <div class="form-con">
                <i-form ref="loginForm" :model="form" :rules="rules">
                    ...
                    <i-form-item prop="captcha">
                        <i-input type="text" v-model="form.captcha" placeholder="验证码">
                        <span slot="prepend">
                                    <Icon :size="6" type="nuclear"></Icon>
                                </span>
                        </i-input>
                    </i-form-item>
                    <i-form-item>
        ...
        <Modal v-model="1" title="Welcome">Welcome to iView</Modal>
    </div>
</div>
            ...
            handleSubmit () {
                this.$refs.loginForm.validate((valid) => {
                    if (valid) {
                        ...
                        this.$store.commit('setAvator', 'https://avatars1.githubusercontent.com/u/17718352');
